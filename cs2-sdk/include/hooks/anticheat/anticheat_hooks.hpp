...
namespace instrumentation {
    ...
    /// and its arguments.
    /// </summary>
    using nt_set_information_process_t = NTSTATUS(NTAPI*)(HANDLE, PROCESS_INFORMATION_CLASS, PVOID, ULONG);
    /// <summary>
    ...
    /// Hooked functions.
    /// </summary>
    inline std::vector<uintptr_t> hooked;
}  // namespace instrumentation
